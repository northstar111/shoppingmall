...
<head>
    ...
    <script type="application/javascript" src="js/controller/pageController.js"></script>
    <script>
        var skuList = [
        <#list tbItems as item>
            {
                "id":${item.id?c},
                "title": "${item.title}",
                "price":${item.price?c},
...
<#assign specList=tbGoodsDesc.specificationItems?eval>
</head>

<body ng-app="pyg" ng-controller="pageController" ng-init="loadSku()">
<!--引入页眉-->
<#include "header.ftl">
                    ...
                    <div class="summary-wrap">
                        <div class="fl title">
                            <div class="control-group">
                                <div class="controls">
                                    <input autocomplete="off" type="text" value="{{goodsNum}}" readonly="readonly"
                                           class="itxt"/>
                    ...
                    <div class="tab-content tab-wraped">
                        <div id="one" class="tab-pane active">
                            <ul class="goods-intro unstyled">
                                <li>${tbGoodsDesc.introduction}</li>
                            </ul>
